...
class Xception_GAP_PretrainedConfiguration(TrainingConfiguration):
    ...
    def classifier(self) -> Model:
        ...
        base_model = Xception(include_top=False, weights='imagenet', input_shape=self.data_shape, pooling=None)
        x = base_model.output
...
if __name__ == "__main__":
    configuration = Xception_GAP_PretrainedConfiguration(1920, 1080)

...
class ResNet50GapPreserveSpaceConfiguration(TrainingConfiguration):
    ...
    def classifier(self) -> Model:
        ...
        x = base_model.layers[-2].output # Get activation before last convolution
    ...
    def name(self) -> str:
        ...
        return "res_net_50_gap_preserve_space"


if __name__ == "__main__":
    configuration = ResNet50GapPreserveSpaceConfiguration(1920, 1080)
